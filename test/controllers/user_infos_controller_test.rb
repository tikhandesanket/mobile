...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, user_info: { company_name: @user_info.company_name, e_mail: @user_info.e_mail, education: @user_info.education, mark: @user_info.mark, name: @user_info.name, position: @user_info.position }
    end
  ...
  test "should update user_info" do
    patch :update, id: @user_info, user_info: { company_name: @user_info.company_name, e_mail: @user_info.e_mail, education: @user_info.education, mark: @user_info.mark, name: @user_info.name, position: @user_info.position }
    assert_redirected_to user_info_path(assigns(:user_info))
  end
